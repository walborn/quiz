...
const segments = [
	{
		title: "Маркетплейсы",
		description: "Быстрый запуск карточек на WB, Ozon и Яндекс Маркет.",
		emoji: "🛍️",
	},
	{
		title: "Импорт",
		description: "Подготовка документов для первой и повторной поставки.",
		emoji: "✈️",
	},
	{
		title: "Производители РФ",
		description: "Сертификация серийного выпуска и новых SKU.",
		emoji: "🏭",
	},
];
...
const advantages = [
	{
		title: "Собственные лаборатории",
		description: "Ускоряем испытания без длинной цепочки подрядчиков.",
		emoji: "🧪",
	},
	{
		title: "Прозрачные сроки",
		description: "Фиксируем этапы и держим вас в курсе по каждому шагу.",
		emoji: "⏱️",
	},
	{
		title: "Работаем по РФ",
		description: "Удалённое сопровождение и доставка оригиналов документов.",
		emoji: "📦",
	},
	{
		title: "Под ключ",
		description: "От подбора схемы до готового комплекта для продаж.",
		emoji: "🧩",
	},
	{
		title: "Эксперты по регламентам",
		description: "Учитываем требования законодательства и отрасли.",
		emoji: "📘",
	},
];
...
const cases = [
	{
		product: "Косметика",
		deadline: "5 дней",
		result: "Запуск продаж на маркетплейсах без задержек",
	},
	{
		product: "Детские товары",
		deadline: "7 дней",
		result: "Успешный ввоз первой партии в РФ",
	},
	{
		product: "Электроника",
		deadline: "4 дня",
		result: "Оформление декларации для серийных поставок",
	},
];
...
const trustItems = [
	{
		title: "Лаборатории",
		description: "Аккредитованные площадки для испытаний",
		emoji: "🏢",
	},
	{
		title: "Документы",
		description: "Работаем по действующим техрегламентам",
		emoji: "📄",
	},
	{
		title: "Партнёры",
		description: "Поддержка поставщиков и брендов из разных ниш",
		emoji: "🤝",
	},
	{
		title: "Экспертность",
		description: "Команда с практикой в B2B сертификации",
		emoji: "🎓",
	},
];
...
const faqItems = [
	{
		...
		answer:
			"В среднем 3–7 рабочих дней. Точный срок зависит от типа продукции и набора документов.",
	},
	{
		question: "Можно ли запустить процесс, если документов пока нет?",
		answer:
			"Да, поможем собрать комплект по чек-листу и подскажем, что подготовить в первую очередь.",
	},
	{
		question: "Вы работаете с импортом и маркетплейсами одновременно?",
		answer:
			"Да, строим маршрут под ваш кейс: ввоз, испытания, оформление и подготовка для площадок.",
	},
];

function App() {
	return (
		<main className="mx-auto flex min-h-svh w-full max-w-330 flex-col gap-10 px-4 py-8 sm:gap-16 sm:px-6 sm:py-12 lg:gap-24 lg:px-8">
			<header className="mx-auto max-w-2xl text-center">
				...
				<p className="mb-6 text-pretty text-base text-muted-foreground sm:text-lg">
					Собственные лаборатории, без лишних посредников. Оформим документы под
			...
			>
				<div className="mx-auto mb-6 max-w-2xl text-center">
					...
					<p className="text-sm text-muted-foreground sm:text-base">
						Подберём формат сертификации под вашу продукцию и задачу
					</p>
				</div>
				<QuizFlow />
			</section>
			...
			<section
				...
				className="rounded-2xl border border-border bg-muted/70 p-6 sm:p-8"
			>
			...
			<section className="rounded-2xl bg-primary p-6 text-primary-foreground sm:p-10">
				<div className="mx-auto flex max-w-3xl flex-col items-center gap-4 text-center">
					...
					<p className="text-sm text-primary-foreground/90 sm:text-base">
						Ответьте на вопросы квиза, и специалист подготовит решение под ваш
						товар и канал продаж.
					</p>
					<Button
						variant="default"
						size="lg"
			...
			>
				<Card>
					<CardHeader>
						<CardTitle id="lead-form-heading">
							Оставьте заявку на консультацию
						</CardTitle>
						<CardDescription>
							Перезвоним, уточним задачу и подскажем оптимальный формат
							сертификации.
						</CardDescription>
					</CardHeader>
					<CardContent>
			...
			<footer className="border-t border-border pt-8 text-center text-xs text-muted-foreground sm:text-sm">
				<p>
					Работаем по всей России. Готовы подключить отправку лидов в CRM или
					Telegram по вашему процессу.
				</p>
			</footer>
		</main>
	);
