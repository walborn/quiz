...
export const QuizFlow: React.FC = () => {
	...
	const handleToggle = (optionId: string) =>
		dispatch({ type: "toggle", payload: optionId });
		...
		return (
			<Card className="mx-auto w-full max-w-2xl">
				...
				<CardFooter className="p-6">
					<Button
						className="mx-auto cursor-pointer sm:w-auto"
						type="button"
						variant="ghost"
					...
					<div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
						{step.options.map((option) => (
							<button
								...
								type="button"
								className={cn(
									"cursor-pointer flex min-h-22 flex-col items-center justify-center gap-2 rounded-lg border-2 border-border bg-card p-4 text-center transition-colors",
